<p align="center">
<img src="https://github.com/yatoub/Tao-ISO/blob/main/assets/tao.svg?raw=true" width=25% height=25%>
</p>

<h1 align="center">[WIP] Tao Linux ISOs</h1>

<p align="center">The repository that hosts the Archiso profile and ISO releases for Tao Linux</p>
...
**Please note that Tao is currently in early stages. Expect bugs.** With that being said, you have two options to obtain an ISO: You can either download a release version of Tao, or you can build a Tao ISO yourself!

### Downloading a release ISO
1. Visit the [Releases](https://github.com/yatoub/Tao-ISO/releases) page.
2. Scroll down until you see the first link that says something similar to `taolinux-XX.YY-x86_64.iso`.
3. Click the link. Your download should then start.

### Building the Archiso profile

You'll need an Arch Linux([-based](https://wiki.archlinux.org/title/Arch-based_distributions)) system to build a Tao ISO.
...
```bash
git clone https://github.com/yatoub/Tao-ISO/
```
...
First, boot into your new system by selecting the new "Tao" option as your boot device.
...
Congratulations! Tao Linux is now fully installed on your computer and you can set it up to your heart's content.
